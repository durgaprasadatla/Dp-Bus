...
const BusNavbar2 = () => {
  return (
    <div>
        ...
        <NavLink to="/hotels1" style={{margin:"20px" ,fontSize:"30px" ,marginTop:"0.3em",marginRight:"20px",textDecoration:"none",width:"100px",borderRadius:"20px",color:"white"}}><i className='bi bi-building-fill hotel_icon3'></i>Hotels</NavLink>
        ...
        <NavLink to="" style={{margin:"20px" ,fontSize:"30px" ,marginTop:"0.3em",marginRight:"20px",textDecoration:"none",width:"100px",borderRadius:"20px",color:"white"}}>Bueses Booking</NavLink>

    </div>
  )
}

export default BusNavbar2