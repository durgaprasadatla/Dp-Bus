...
const BuessNavbar = () => {
  return (
    <div>
                           ...
                           <NavLink to="" style={{margin:"20px" ,fontSize:"30px" ,marginTop:"0.3em",marginRight:"20px",textDecoration:"none",width:"100px",borderRadius:"20px",color:"white"}}>Flights Booking</NavLink>
           </div>
  )
}

export default BuessNavbar